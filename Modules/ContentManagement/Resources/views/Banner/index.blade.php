...
<div class="box">
    <div class="box-header with-border">
      <a href="{{ route('admin.content-management.banner.create') }}"><button class="btn btn-primary">Add New &nbsp;<i class="fa fa-plus"></i></button></a>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      ...
      <table id="example1" class="table table-bordered table-striped banner-table">
        ...
        <tr>
            <td>{{ $index + 1 }}</td>
            <td>{!! str_limit(strip_tags($record->caption), 40) !!}</td>
            <td class="image">
                @if($record->attachment)
                    <img src="{{ asset('uploads/content-management/banner/' . $record->attachment) }}" alt="{{ $record->name }}" width="200">
                @endif
            </td>
            <td>
            ...
            <td>
                <a href="{{ route('admin.content-management.banner.edit', $record->id) }}" title="Edit banner"><button class="btn btn-primary btn-flat"><i class="fa fa-edit"></i></button></a>&nbsp;
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        swal({
            ...
            $.ajax({
                type: "DELETE",
                url: "{{ url('/admin/content-management/banner') }}"+"/"+id,
                dataType: 'json',
