...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#bannerAddForm').formValidation({
            ...
            $('#bannerAddForm').formValidation('revalidateField', 'caption');
            $('#bannerAddForm').formValidation('revalidateField', 'description');
                ...
                .each(function () {
                    $(this)
                        ...
                        .on('change', function (e) {
                            $('#bannerAddForm').formValidation('revalidateField', e.sender.name);
                        });
                });
    });
</script>
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="bannerAddForm" method="POST" action="{{ route('admin.content-management.banner.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
        @include('layouts.backend.alert')
            ...
            <div class="form-group">
                ...
                <input type="text" name="caption" class="form-control" id="caption" placeholder="Enter caption." value="{{ old('caption') }}" >
            </div>
            ...
            <div class="form-group">
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new thumbnail" style="width: 600px; height: auto;">
                        <img src="{{ asset('uploads/content-management/banner/default-img.jpg') }}" alt="">
                    </div>
