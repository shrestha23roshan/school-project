...
<script type="text/javascript">
    $(document).ready(function () {
        $('#aboutusEditForm').formValidation({
            ...
            $('#aboutusEditForm').formValidation('revalidateField', 'heading');
...
<div class="box box-primary">
    ...
    <!-- /.box-header -->
    <!-- form start -->
    <form id="aboutusEditForm" method="POST" action="{{ route('admin.content-management.aboutus.update', $aboutUs->id) }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="box-body">
        @include('layouts.backend.alert')
            ...
            <div class="form-group">
                ...
                <input type="text" name="heading" class="form-control" id="heading" placeholder="Enter heading." value="{{ $aboutUs->heading }}" >
            </div>
            ...
            <div class="form-group">
                ...
                <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new thumbnail" >
                        @if(file_exists('uploads/content-management/aboutus/'.$aboutUs->attachment) && $aboutUs->attachment != '')
                            <img src="{{ asset('uploads/content-management/aboutus/'.$aboutUs->attachment) }}" alt="{{ $aboutUs->name }}">
                        @else
                            <img src="{{ asset('uploads/content-management/aboutus/default-img.jpg') }}" alt="default-image">
                        @endif
                    </div>
